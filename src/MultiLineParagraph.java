...
//Adapted from https://memorynotfound.com/apache-pdfbox-adding-multiline-paragraph/
public class MultiLineParagraph {
    ...
    public static void insertParagraphIntoPDF(PDDocument doc, String text) throws IOException  {
